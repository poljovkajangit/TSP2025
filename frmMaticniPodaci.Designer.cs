namespace TSP2025
{
    partial class frmMaticniPodaci
    {
        ...
        private void InitializeComponent()
        {
            ...
            ImaMernoMestoPreview = new DataGridViewTextBoxColumn();
            ...
            label11 = new Label();
            btnPodstaniceObrisi = new Button();
            btnPodstaniceDodaj = new Button();
            btnPodstanicaMernoMesto = new Button();
            tabIndividaulniPotrosaci = new TabPage();
            btnIndividualniPotrosacMernoMesto = new Button();
            btnIndividualniPodstanice = new Button();
            gbIndividualniPotrosaci = new GroupBox();
            tbIndividualniPotrosacSifraKorisnika = new TextBox();
            label16 = new Label();
            ...
            dgPodstanice.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle7;
            dgPodstanice.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgPodstanice.Columns.AddRange(new DataGridViewColumn[] { nazivDataGridViewTextBoxColumn2, ImaMernoMestoPreview });
            ...
            nazivDataGridViewTextBoxColumn2.HeaderText = "Podstanica";
            ...
            tabPage1.Controls.Add(btnPodstaniceObrisi);
            tabPage1.Controls.Add(btnPodstaniceDodaj);
            ...
            btnPodstaniceObrisi.UseVisualStyleBackColor = true;
            btnPodstaniceObrisi.Click += btnKPodstaniceObrisi_Click;
            // 
            // btnPodstaniceDodaj
            // 
            ...
            btnPodstaniceDodaj.UseVisualStyleBackColor = true;
            btnPodstaniceDodaj.Click += btnPodstaniceDodaj_Click;
            // 
            ...
            btnPodstanicaMernoMesto.Text = "Dodaj merno mesto ...";
            btnPodstanicaMernoMesto.UseVisualStyleBackColor = true;
            btnPodstanicaMernoMesto.Visible = false;
            btnPodstanicaMernoMesto.Click += btnPodstaniceDodajMernoMesto_Click;
            // 
            // tabIndividaulniPotrosaci
            // 
            tabIndividaulniPotrosaci.Controls.Add(btnIndividualniPotrosacMernoMesto);
            ...
            btnIndividualniPotrosacMernoMesto.Text = "Dodaj merno mesto ...";
            btnIndividualniPotrosacMernoMesto.UseVisualStyleBackColor = true;
            btnIndividualniPotrosacMernoMesto.Visible = false;
            btnIndividualniPotrosacMernoMesto.Click += btnIndividualniPotrosacMernoMesto_Click;
            // 
            ...
            // 
            gbIndividualniPotrosaci.Controls.Add(tbIndividualniPotrosacSifraKorisnika);
            gbIndividualniPotrosaci.Controls.Add(label16);
            ...
            // 
            // tbIndividualniPotrosacSifraKorisnika
            // 
            tbIndividualniPotrosacSifraKorisnika.BackColor = Color.White;
            ...
            label12.Location = new Point(24, 70);
            ...
            label14.Location = new Point(24, 162);
            ...
            label15.Location = new Point(24, 208);
            ...
            dgIndividualniPotrosaci.AllowUserToResizeColumns = false;
            ...
            dgIndividualniPotrosaci.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle10;
            dgIndividualniPotrosaci.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgIndividualniPotrosaci.Columns.AddRange(new DataGridViewColumn[] { nazivDataGridViewTextBoxColumn3, dataGridViewTextBoxColumn2 });
        ...
        private Button btnPodstaniceObrisi;
        private Button btnPodstaniceDodaj;
